...
} from "./chunk-I5472BWL.js";
import {
  require_jsx_runtime
} from "./chunk-OLBJ6L5L.js";
import {
  require_react
} from "./chunk-HJEDEILD.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
var Throttler = class {
  constructor(fn, initialOptions) {
    ...
    __privateGet(this, _setState).call(this, this.options.initialState ?? {});
...
function useFieldGroup(opts) {
  const [formLensApi] = (0, import_react4.useState)(() => {
...
function createFormHookContexts() {
  function useFieldContext() {
    const field = (0, import_react5.useContext)(fieldContext);
    if (!field) {
      throw new Error(
  ...
  function useFormContext() {
    const form = (0, import_react5.useContext)(formContext);
    if (!form) {
      throw new Error(
...
function createFormHook({
  ...
  function useAppForm(props) {
    ...
    const extendedForm = (0, import_react5.useMemo)(() => {
  ...
  function withFieldGroup({
    ...
    return function Render(innerProps) {
      const fieldGroupProps = (0, import_react5.useMemo)(() => {
        return {
