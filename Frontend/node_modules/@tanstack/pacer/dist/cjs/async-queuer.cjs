...
class AsyncQueuer {
  constructor(fn, initialOptions = {}) {
    ...
    this.#setState = (newState) => {
      ...
      eventClient.emitChange("AsyncQueuer", this);
    };
    this.#getWait = () => {
    ...
    eventClient.pacerEventClient.on("d-AsyncQueuer", (e) => {
...
//# sourceMappingURL=async-queuer.cjs.map
